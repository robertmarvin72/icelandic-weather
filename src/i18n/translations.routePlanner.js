export const routePlannerTranslations = {
  en: {
    routeReasonRainStreak: "Fewer rainy days in a row",
    routeReasonGust: "Calmer gusts",
    routeReasonWind: "Lower wind exposure",
    routeReasonRain: "Less rain expected",
    routeReasonTemp: "Warmer daytime temperatures",
    routeReasonShelter: "More wind shelter",
    ...
    routePlannerShowAdvanced: "Advanced settings",
    routePlannerHideAdvanced: "Hide advanced settings",
    ...
    routeReason_wind: "Lower wind exposure",
    routeReason_gust: "Calmer gusts",
    routeReason_rain: "Less rain expected",
    ...
    routeStayGoodSpot: "Your current campsite compares well with nearby options.",

    impactWind: "Strong wind makes camping uncomfortable and tent pitching harder.",
    impactGust: "Gusts stress tent poles and pegs — especially overnight.",
    impactRain: "Rain keeps you in the tent and dampens gear.",
    impactRainStreak: "Consecutive rainy days make outdoor activities difficult.",
    impactColdWind: "Cold with wind makes sleeping and outdoor time more tiring.",
    impactWintry: "Snow or freezing rain adds risk and makes camp tasks harder.",
    impactShelter: "Natural shelter reduces felt wind and improves overall comfort.",
    ...
    routePainMoveHeadline: "Why this matters",
    routePainMoveBody: "Moving could help you avoid the worst of the weather.",
    routePainMoveBulletAvoidWorst: "Moving could help you avoid the worst of the weather.",
    routePainMoveBulletStuckInside: "Less chance of being stuck inside because of the weather.",
    ...
    freeRecommendationBadge: "1 free recommendation per day",
  ...
  is: {
    ...
    routeReasonGust: "Rólegri hviður",
    routeReasonWind: "Minni vindálag",
    routeReasonRain: "Minna rigning á leiðinni",
    routeReasonTemp: "Hlýrra yfir daginn",
    routeReasonShelter: "Meira vindskjól",
    ...
    routePlannerShowAdvanced: "Ítarlegar stillingar",
    routePlannerHideAdvanced: "Fela ítarlegar stillingar",
    ...
    routeReason_wind: "Minni vindálag",
    routeReason_gust: "Rólegri hviður",
    routeReason_rain: "Minna rigning á leiðinni",
    ...
    routeStayGoodSpot: "Núverandi tjaldsvæðið þitt ber sig vel saman við nálægar leiðir.",

    impactWind: "Sterkur vindur gerir tjaldlíf erfitt og erfiðara að tjalda.",
    impactGust: "Hviður setja tjaldstör og pinnar í þraut — sérstaklega á nóttunni.",
    impactRain: "Rigning heldur þér inni og bleytir búnað.",
    impactRainStreak: "Margir rigningardagar í röð gera útiveru erfið.",
    impactColdWind: "Kuldi með vindi gerir svefn og útiveru þreytandi.",
    impactWintry: "Snjór eða frárigning bætir við áhættu og gerir tjaldlíf erfiðara.",
    impactShelter: "Náttúrulegt skjól dregur úr fundnum vindi og eykur þægindi.",
    ...
    routePainMoveHeadline: "Af hverju skiptir þetta máli",
    routePainMoveBody: "Að færa sig gæti hjálpað þér að forðast versta veðrið.",
    routePainMoveBulletAvoidWorst: "Að færa sig gæti hjálpað þér að forðast versta veðrið.",
    routePainMoveBulletStuckInside: "Minni líkur á að sitja fastur inni í tjaldi eða bíl vegna veðurs.",
    ...
    freeRecommendationBadge: "1 ókeypis ráðgjöf á dag",
