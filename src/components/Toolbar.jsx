...
export default function Toolbar({
  ...
  return (
    <header className="relative z-30 mb-3 md:mb-4">
      ...
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        ...
        {/* Primary selector + settings toggle — grouped in right column */}
        <div className="relative z-30 flex flex-col items-end gap-1 self-start">
          <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-slate-200/80 bg-white/70 px-3 py-2.5 shadow-sm backdrop-blur-sm dark:border-slate-700/80 dark:bg-slate-900/70">
